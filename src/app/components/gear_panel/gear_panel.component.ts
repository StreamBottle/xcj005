...
export class GearPanelComponent implements OnDestroy, OnInit {
  ...
  brakeOn(_obj) {
    ...
    if (_top == 40) {
      ...
      if (
        ...
        // if (((this.appService.progressData.describeFlag !== 13 && this.appService.moni1IsOk) || (this.appService.progressData.describeFlag !== 15 && this.appService.moni1IsOk) || (this.appService.progressData.describeFlag !== 19 && this.appService.moni2IsOk) || (this.appService.progressData.describeFlag !== 21 && this.appService.moni2IsOk) || (this.appService.progressData.describeFlag !== 25 && this.appService.moni3IsOk) || (this.appService.progressData.describeFlag !== 27 && this.appService.moni3IsOk) || (this.appService.progressData.describeFlag !== 31 && this.appService.moni4IsOk) || (this.appService.progressData.describeFlag !== 33 && this.appService.moni4IsOk)) || this.appService.progressData.describeFlag == 37 || this.appService.progressData.describeFlag == 39 || this.appService.progressData.describeFlag == 41) {
        if (this.appService.progressData.describeFlag == 13 || this.appService.progressData.describeFlag == 15 || this.appService.progressData.describeFlag == 17 ||
          this.appService.progressData.describeFlag == 19 || this.appService.progressData.describeFlag == 21 || this.appService.progressData.describeFlag == 23 ||
          this.appService.progressData.describeFlag == 25 || this.appService.progressData.describeFlag == 27 || this.appService.progressData.describeFlag == 29 ||
          this.appService.progressData.describeFlag == 31 || this.appService.progressData.describeFlag == 33 || this.appService.progressData.describeFlag == 35
        ) {
  ...
  * */
  ...
  dragDragAccelerator() {
    ...
    // console.log(this.multimeterService.pedalA());
    // this.multimeterService.Mdata.isDrop(null, null, null);

    // console.log(
    //   this.multimeterService.Mdata.Adata['0'].dvNum.toall[6][1],
    //   132131321321
    // );
    // console.log(
    //   this.multimeterService.Mdata.Adata['0'].dvNum.toall[6][1]['call'](this),
    //   '132131321321ghfhfhgfhfh'
    // );
  ...
  switchGear(id, obj) {
    ...
    if (this.dashboardService.stalls == 1) {
      if (id == 1) {
        ...
        this.dashboardService.stallScintillation(this.dashboardService.pageLight[this.appService.progressData.describeFlag], 'R')
        ...
        this.dashboardService.stallScintillation(this.dashboardService.pageLight[this.appService.progressData.describeFlag], 'D')
