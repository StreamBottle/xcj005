...
export class MultimeterService {
  ...
  Mdata = {
          ...
          toall: [
            {
              ...
              V2_GND: [0, 5, 0, 5],
              GND_V2: [0, 5, 0, 5],
              V95_GND: [0, 13.8, 0, 13.8],
              GND_V95: [0, 13.8, 0, 13.8],
              T1_GND: [0, 5, 0, 5],
              GND_T1: [0, 5, 0, 5],
              T2_GND: [0, 5, 0, 5],
              GND_T2: [0, 5, 0, 5],
              ...
              V2_V80: [0, 5, 0, 5],
              V80_V2: [0, 5, 0, 5],
              V95_V80: [0, 13.8, 0, 13.8],
              V80_V95: [0, 13.8, 0, 13.8],
              T1_V80: [0, 5, 0, 5],
              V80_T1: [0, 5, 0, 5],
              T2_V80: [0, 5, 0, 5],
              V80_T2: [0, 5, 0, 5],
          ...
          offT6: [
            {
              ...
              V95_V1: [0, 8.8, 0, 8.8],
              V1_V95: [0, 8.8, 0, 8.8],
              V95_V2: [0, 13.8, 0, 13.8],
              V2_V95: [0, 13.8, 0, 13.8],
              V95_T1: [0, 8.8, 0, 8.8],
              T1_V95: [0, 8.8, 0, 8.8],
              V95_T2: [0, 13.8, 0, 13.8],
              T2_V95: [0, 13.8, 0, 13.8],
              V1_V2: [0, 5, 0, 5],
              V2_V1: [0, 5, 0, 5],
              T1_T2: [0, 5, 0, 5],
              T2_T1: [0, 5, 0, 5],
    ...
    isfirst: { "15": true, "21": true, "27": true, "33": true },
    ...
    changeFilesInit() {
      ...
      //       $(".bgpic-circuit").css(
      //         "backgroundImage",
      //         "url(./assets/images/skill/13.png)"
      //       );
      //     });
      //     break;
      // }
    ...
    freshHontspotDrop(eventID, uiDraggableID) {
      ...
      // //万用表打到电压挡时，万用表的表笔首次没有放到蓄电池的两个热区时，会弹出对话框，“请先测量蓄电池两端的电压”
      // if (this.Mint.In1NER_Multi_ACVlt_x_x == "1") {
      //   if ((this.multimeterblackPosition != "GND" && this.multimeterredPosition != "A") || (this.multimeterredPosition != "GND" && this.multimeterblackPosition != "A")) {
      //     if (this.isfirst[this.appService.progressData.describeFlag]) {
      //       this.handleErrorService.handleError({ message: "请先测量蓄电池两端的电压" });
      //       this.isfirst[this.appService.progressData.describeFlag] = false;
      //     }
      //   }
      // }
      ...
      if (
        ...
        $("#oscilloscope-black").css(
          "top",
          "" + (parseInt($(eventID).attr("h-top"), 10) - 200) + "px"
        );
        $("#oscilloscope-black").css(
          "left",
          "" + (parseInt($(eventID).attr("h-left"), 10) - 10) + "px"
        );
        $("#oscilloscopeHot-black").css(
          "top",
          "" + (parseInt($(eventID).attr("h-top"), 10) + 25) + "px"
        );
        $("#oscilloscopeHot-black").css(
          "left",
          "" + (parseInt($(eventID).attr("h-left"), 10) - 10) + "px"
    ...
    freshHontspot() {
      ...
      $("body")
        .find("a")
        .droppable({
          accept: "#hhjmultimeterBlack-hotspot,#hhjmultimeterRed-hotspot,#oscilloscopeHot-red,#oscilloscopeHot-black",
          tolerance: "pointer",
          greedy: true,
    ...
    Mint: {
      ...
      In1NER_Multi_ACVlt_x_x: "0", // 电压直流
      In1NER_Multi_DCVlt_x_x: "0", // 电压交流
    ...
    isDrop(eventID, uiDraggableID, isGears) {
      ...
      this.DCElectric = (pinType, id, isGears) => {
        ...
        //万用表打到电压挡时，万用表的表笔首次没有放到蓄电池的两个热区时，会弹出对话框，“请先测量蓄电池两端的电压”
        if (this.multimeterScreenUnit == "V" && this.multimeterblackPosition && this.multimeterredPosition &&
          (this.multimeterredPosition == "A" && this.multimeterblackPosition == "GND") || (this.multimeterblackPosition == "A" && this.multimeterredPosition == "GND")
        ) {
          if (this.isfirst[this.appService.progressData.describeFlag]) {
            this.isfirst[this.appService.progressData.describeFlag] = false;
            console.log("GND-A-SDF");
          }
        } else if (this.multimeterScreenUnit == "V" &&
          (this.multimeterblackPosition != "GND" || this.multimeterredPosition != "A" || this.multimeterredPosition != "GND" || this.multimeterblackPosition != "A")
        ) {
          if (this.isfirst[this.appService.progressData.describeFlag]) {
            this.handleErrorService.handleError({ message: "请先测量蓄电池两端的电压" });
            this.isfirst[this.appService.progressData.describeFlag] = false;
        ...
        if (
          ...
          // ];
          // if (
          //   this.Adata[this.appService.currentFault].dvNum[
          //   this.currentPinOut
          //   ] &&
          //   this.Adata[this.appService.currentFault].dvNum[
          //   this.currentPinOut
        ...
        // 蓄电池正极与除蓄电池负极及V80以外的点测量,电压为0
        // if (this.multimeterScreenUnit == "V" &&
        //   this.multimeterblackPosition &&
        //   this.multimeterredPosition &&
        //   (this.multimeterredPosition == "A" && (this.multimeterblackPosition != "GND" && this.multimeterblackPosition != "V80")) || (
        //     this.multimeterblackPosition == "A" && (this.multimeterredPosition != "GND" && this.multimeterredPosition != "V80"))
        // ) {
        //   console.log("A");
        //   return;
        // }

        // V95在offV和allOut状态下，与除蓄电池负极及V80以外的点测量,电压为0
        // if ((pinType === "offV" || pinType === "allOut") && this.multimeterScreenUnit == "V" &&
        //   this.multimeterblackPosition &&
        //   this.multimeterredPosition &&
        //   (this.multimeterredPosition == "V95" && (this.multimeterblackPosition != "GND" && this.multimeterblackPosition != "V80")) || (
        //     this.multimeterblackPosition == "V95" && (this.multimeterredPosition != "GND" && this.multimeterredPosition != "V80"))
        // ) {
        //   console.log("V95");
        //   return;
        // }
        ...
        let isRandomNum = (num) => {
          ...
          if (
            ...
            this.wybShow = Math.abs(arrRed[num].call(that) - arrBlack[num]).toFixed(
              1
            );
            return true;
          }
          if (
            ...
            this.wybShow = Math.abs(arrRed[num] - arrBlack[num].call(that)).toFixed(
              1
            );
            return true;
          }
        ...
        if (!this.dashboardService.stalls && !this.gearPanelService.isBrake) {
          ...
          isRandomNum(0) ? '' : this.wybShow = Math.abs(arrRed[0] - arrBlack[0]).toFixed(2);
        } else if (
          this.dashboardService.stalls &&
          !this.gearPanelService.isBrake
        ) {
          ...
          isRandomNum(1) ? '' : this.wybShow = Math.abs(arrRed[1] - arrBlack[1]).toFixed(2);
        } else if (
          !this.dashboardService.stalls &&
          this.gearPanelService.isBrake
        ) {
          ...
          isRandomNum(2) ? '' : this.wybShow = Math.abs(arrRed[2] - arrBlack[2]).toFixed(2);
        } else if (
          this.dashboardService.stalls &&
          this.gearPanelService.isBrake
        ) {
          ...
          isRandomNum(3) ? '' : this.wybShow = Math.abs(arrRed[3] - arrBlack[3]).toFixed(2);
        }
      ...
      this.resistance = () => {
        ...
        console.log(currentOsciMeasureOhm);
        console.log(this.Adata[this.appService.currentFault].resistance[this.currentPinOut]);
        if (
      ...
      this.insulationRes = () => {
        ...
        if (
          ...
          this.resShow = this.Adata[this.appService.currentFault].resistance[
            this.currentPinOut
          ][currentOsciMeasureOhm.join("_")][0];
        } else if (
          this.Adata[this.appService.currentFault].resistance[
      ...
      console.log(this.Mint.In1NER_Multi_Pass2Ohm_x_x, this.currentPinOut, 'klklklk');
      // 交流电压或直流电压档位档位
      if (
        (this.Mint.In1NER_Multi_ACVlt_x_x === "1" ||
          this.Mint.In1NER_Multi_DCVlt_x_x == "1") &&
        ...
        // 测量电阻
        if (this.currentPinOut == "toall") {
          // 判断放置表笔时是否拔下插头
          if (uiDraggableID === "hhjmultimeterRed-hotspot") {
            this.handleErrorService.handleError({ message: "测量电阻前，请断开插头" });
        ...
        if (this.dashboardService.stalls) {
          this.handleErrorService.handleError({ message: "不允许测量" });
          return;
        }
        this.resistance();
      } else if (this.Mint.In1NER_Multi_Insulate_Ohm_x === "1") {
        if (
          ...
          if (uiDraggableID === "hhjmultimeterRed-hotspot") {
            this.handleErrorService.handleError({ message: "请将绝缘检测仪负极表夹连接到车身负极搭铁" });
            this.multimeterredRecover(null, null);
            return;
          } else if (uiDraggableID === "hhjmultimeterBlack-hotspot") {
            this.handleErrorService.handleError({ message: "请将绝缘检测仪负极表夹连接到车身负极搭铁" });
