...
class Adapter {
    ...
    constructor(private handleErrorService: HandleErrorService, private appService: AppService) {
        ...
        // 无通信服务时打开
        if ((window.location.host).includes('9014')) {
            console.log(123);
            this.characterB = {
                "chapter": [
                    {
                        ...
                        "chapter": [
                            ...
                            },
                            {
                                ...
                                "page": [
                                    ...
                                    {
                                        "description": "诊断2",
                                        "id": "chapter02_04_page_02",
                                        "time": "30"
                                    },
                                    {
                                        "description": "诊断3",
                                        "id": "chapter02_04_page_03",
                                        "time": "30"
                                    },
                                    {
                                        "description": "诊断4",
                                        "id": "chapter02_04_page_04",
                                        "time": "30"
                                    },
                                ]
                            },
    ...
    init() {
        ...
        // 无通信服务时打开
        if ((window.location.host).includes('9014') || (window.location.host).includes('9017') || (window.location.host).includes('9019')) {
