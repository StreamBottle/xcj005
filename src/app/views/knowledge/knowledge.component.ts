...
export class KnowledgeComponent implements OnInit, OnDestroy {
	...
	imgs=[
	{"img":"./assets/images//knowledge/img2a.png"},
	{"img":"./assets/images//knowledge/img2b.png"},
	{"img":"./assets/images//knowledge/img2c.png"},
	{"img":"./assets/images//knowledge/img2d.png"}
	];
	imgx=[
	{"img":"./assets/images//knowledge/R_Ok.png"},
	{"img":"./assets/images//knowledge/img5.png"},
	{"img":"./assets/images//knowledge/D_OK.png"}
	];
	imgq=[
	{"img":"./assets/images//knowledge/cc06.gif"},
	{"img":"./assets/images//knowledge/cc01.png"},
	{"img":"./assets/images//knowledge/cc07.gif"}
	];
	imgk=[
	{"img":"./assets/images//knowledge/cc02.png"},
	{"img":"./assets/images//knowledge/cc03.gif"},
	{"img":"./assets/images//knowledge/cc04.gif"},
	{"img":"./assets/images//knowledge/cc05.gif"}
	];
	abc: string = 'inactive';
	@ViewChild('hua2') hua2;
	@ViewChild('hua1') hua1;
