      ...
      if (
        (cont == "measureTool" &&
          (this.appService.progressData.describeFlag == 2 ||
            ...
            (this.appService.progressData.describeFlag == 29 && this.appService.OneNavState == 2) ||
            (this.appService.progressData.describeFlag == 31 && this.appService.OneNavState == 3) ||
            (this.appService.progressData.describeFlag == 33 && this.appService.OneNavState == 3) ||
            (this.appService.progressData.describeFlag == 35 && this.appService.OneNavState == 3))) ||
        (cont == "controlCenter" &&
          (this.appService.progressData.describeFlag == 2 ||
            this.appService.progressData.describeFlag == 13 ||
            this.appService.progressData.describeFlag == 15 ||
 ...
 */
  ...
  setStandingTime(page: number, enter: boolean, leave: boolean, route?) {
    ...
    let allId = {
      ...
      knowledge_7: 'chapter02_04_page_01',
      knowledge_8: 'chapter02_04_page_02',
      knowledge_9: 'chapter02_04_page_03',
      knowledge_10: 'chapter02_04_page_04',
      knowledge_11: 'chapter02_05_page_01',
      ...
      skill_30: 'chapter03_07_page_01',
      skill_31: 'chapter03_08_page_01',
      skill_32: 'chapter03_09_page_01',
  ...
  setDirectoryRights() {
    ...
    let allId = {
      ...
      knowledge_7: 'chapter02_04',
      knowledge_8: 'chapter02_04',
      knowledge_9: 'chapter02_04',
      knowledge_10: 'chapter02_04',
      knowledge_11: 'chapter02_05',
      ...
      skill_30: 'chapter03_07',
      skill_31: 'chapter03_08',
      skill_32: 'chapter03_09',

      exam_29: 'chapter04_01',
      exam_30: 'chapter04_02',
      exam_31: 'chapter04_02',
      exam_32: 'chapter04_02',
      exam_33: 'chapter04_02',
      exam_34: 'chapter04_02',
      exam_35: 'chapter04_02',
  ...
  recursionNext(isNext) {
    ...
    let nextPage = () => {
      ...
      if (count === 28 && isNext == 'left' && this.appService.OneNavState == 3) {
      ...
      if (count === 12 && (isNext == 'right' || isNext == 'init') && this.appService.OneNavState == 1) {
        this.appService.skillIsPass = false;
        this.appService.OneNavState = 2;
        count = 12;
      }
      if (count === 33 && (isNext == 'right' || isNext == 'init') && this.appService.OneNavState == 2) {
