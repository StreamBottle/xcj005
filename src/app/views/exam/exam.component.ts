...
export class ExamComponent implements OnInit {
  ...
  faultDiagnosisAnswerPic = {
    pic14path: "./assets/images/skill/answer.png",
    pic20path: "./assets/images/skill/answer.png",
    pic26path: "./assets/images/skill/answer.png",
    pic32path: "./assets/images/skill/answer.png",
    pic38path: "./assets/images/skill/answer.png",
  };
  ...
  pullOutUnit(event) {
    if (this.dashboardService.stalls) {
      this.handleErrorService.handleError({ message: "请先关闭点火开关" });
      return;
    }
    this.multimeterService.Mdata.multimeterredRecover();
    this.multimeterService.Mdata.multimeterblackRecover();
